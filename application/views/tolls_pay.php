...
<li><a href="/tolls/">Tolls</a>
</li>
<li><a href="/tolls/pay/" class="active">Pay Tolls</a>
</li>
</ul>
...
<div class="panel-title">Pay Tolls
</div>
</div>
</div>
    ...
    <div class="row">
        <div class="col-md-6 b-r b-dashed b-grey ">
            <div class="padding-30">
                <h2>Tolls Being Paid</h2>
                <p>Below is the list of all tolls you have selected to be paid today for the vehicle <b><?php echo $plate; ?></b></p>
                ...
                <table class="table table-condensed">
                    ...
                    foreach ($tollcheck as $toll_entry) {
                        if ($toll_entry['status']=="Unpaid") {
                            ...
                            echo '</span><span class="m-l-10 "><small><i>Includes Admin Fee ($';
                            echo number_format($toll_entry['admin_charge'],2);
                            echo ')</i></small></span></td><td class=" col-md-3 text-right"><span><b>';
        ...
        <div class="col-md-6">
            <div class="padding-30">
                ...
                <form role="form" action="/tolls/confirmation/" method="POST" id="payment-form">
